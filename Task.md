...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Still visible on production hero (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Primary CTA still navigates away instead of smooth scroll (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Secondary CTA missing on production hero (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Availability text link still present (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Footer copy still “Built with Bun + React + MUI.” (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Heading still shows former text (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Mentorship badge not repositioned (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Mentorship cards still use mailto links (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Contact footer remains in legacy layout (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Production still references `sdarimasih@gmail.com` and lacks Telegram/GitHub entries (checked 2025-11-12 after latest GitHub Pages publish attempt)
...
- Date of Done this task:
- **Local Verification:** ✅ Browser check on localhost (2025-11-12)
- **Production Status:** ❌ Footer action bar absent on production (checked 2025-11-12 after latest GitHub Pages publish attempt)
