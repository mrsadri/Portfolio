...
function parseAndWrapExpression(functionString, expressionValue, themeImportIdentifier) {
  ...
  if (expression.type === "FunctionExpression" || expression.type === "ArrowFunctionExpression") {
    expression.params.push(
      t__namespace.assignmentPattern(t__namespace.identifier("theme"), t__namespace.identifier(themeImportIdentifier != null ? themeImportIdentifier : "theme"))
    );
  }
  return expression;
}
function transformThemeKeysInFn(functionString, options, filename, expressionValue, themeImportIdentifier) {
  ...
  const result = core.transformSync(functionString, {
  ...
  const defaultThemeParam = t__namespace.assignmentPattern(
    t__namespace.identifier("theme"),
    t__namespace.identifier(themeImportIdentifier != null ? themeImportIdentifier : "theme")
  );
  ...
  if (firstItem.type === "FunctionDeclaration") {
    return t__namespace.functionExpression(null, [...firstItem.params, defaultThemeParam], firstItem.body);
  }
  return parseAndWrapExpression(functionString, expressionValue, themeImportIdentifier);
}
...
function processCssObject(cssObj, themeArgs, skipSx = true) {
  ...
  const className = chunk5VRK3JMQ_js.css(processedObj);
  return chunk5VRK3JMQ_js.cache.registered[className];
}

exports.cssFnValueToVariable = cssFnValueToVariable;
exports.processCssObject = processCssObject;
//# sourceMappingURL=chunk-2ZKSYVEZ.js.map
//# sourceMappingURL=chunk-2ZKSYVEZ.js.map