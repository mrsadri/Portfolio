...
function parseAndGenerateFunction(fnString, expression) {
  var _a;
  try {
    const exp = parser.parseExpression(fnString);
    return exp;
  } catch (ex) {
    try {
      const exp = parser.parseExpression(`{${fnString}}`);
      ...
      return core.types.arrowFunctionExpression(propMethod.params, propMethod.body);
    } catch (ex2) {
...
//# sourceMappingURL=chunk-XRFT6ZAT.js.map
//# sourceMappingURL=chunk-XRFT6ZAT.js.map