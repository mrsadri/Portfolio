...
import { BaseProcessor, __spreadValues, __spreadProps } from './chunk-S2BUG7Y4.mjs';
...
var StyledProcessor = class extends BaseProcessor {
  constructor(params, ...args) {
    ...
    this.componentMetaArg = componentMetaArg && componentMetaArg.kind === ValueType.LAZY ? componentMetaArg : void 0;
  ...
  processCss(styleObjOrFn, styleArg, variantsAccumulator, themeImportIdentifier) {
    ...
    styleObj = __spreadValues({}, styleObj);
    if (styleObj.variants) {
      variantsAccumulator == null ? void 0 : variantsAccumulator.push(
        ...styleObj.variants.map((variant) => __spreadProps(__spreadValues({}, variant), {
