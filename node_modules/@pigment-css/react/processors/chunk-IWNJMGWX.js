...
var BaseProcessor = class extends processorUtils.BaseProcessor {
  constructor() {
    super(...arguments);
    this.variableIdx = 0;
  }
  ...
  getCustomVariableId(cssKey, source, hasUnit) {
    ...
    if (!customSlugFn) {
      return processorUtils.toValidCSSIdentifier(`${this.slug}-${context.index}`);
    }
    return typeof customSlugFn === "function" ? customSlugFn(context) : processorUtils.buildSlug(customSlugFn, __spreadValues({}, context));
  }
  ...
  getVariableContext(cssKey, source, hasUnit) {
    ...
    return {
      ...
      source: "",
      unit: "",
      valueSlug: shared.slugify(`${source}${hasUnit}`)
    };
  }
  getImportPath() {
...
//# sourceMappingURL=chunk-IWNJMGWX.js.map
//# sourceMappingURL=chunk-IWNJMGWX.js.map