import { C as CSSObjectNoCallback, T as ThemeArgs } from './theme-aDBfke1X.js';
...
declare function sx(arg: SxProp, componentClass?: string): string;

export { type SxProp as S, sx as s };
