...
- **53M+** Active Users (As of 2025)
- **200M+** Daily Ad Views (~6 billion monthly)
- **#1** Market Leader — Largest classified platform in Iran

**Divar** is Iran's leading classified ads platform with over **53 million active users**. Every week, millions of people buy and sell everything from cars to clothing, making it an essential part of Iran's digital economy.
...
1. **How are harassers finding and targeting our users?** Understanding the mechanism of the problem.
2. **What are users already doing to protect themselves?** Learning from existing user behavior and solutions.
...
### User and Stakeholder Review

We conducted a rapid, thorough user and stakeholder review that revealed:
...
- **~2.1 million active users per week** continuously using the secure call feature to protect themselves
