...
import type { caseStudies } from "../../data/home";
import GhostButton from "./GhostButton";
import Pill from "./Pill";
import PrimaryButton from "./PrimaryButton";

export type CaseStudySummary = (typeof caseStudies)[number];
...
const CaseCard = ({ caseStudy, active = false, onOpenRecap }: CaseCardProps) => {
