...
import { setareYekOverview, setareYekSections } from "./data/setareYekContent";
import { setareYekCaseStudyMetadata } from "./seo";

const CaseStudySetareYekPage = () => {
  const { activeSectionId, handleOutlineClick } = useCaseStudyNavigation(setareYekSections);

  const otherCaseStudies = useRelatedCaseStudies(caseStudyEntries, "setare-yek-bill-payment");

  return (
    <>
      <Seo {...setareYekCaseStudyMetadata} />
...
export default CaseStudySetareYekPage;
